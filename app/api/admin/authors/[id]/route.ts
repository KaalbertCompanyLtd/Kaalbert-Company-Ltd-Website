 ...
 * the request and shapes the response only — every validation/gating rule (including the
 * computed-`published` logic and the can't-unpublish-an-author-with-articles guard) lives in
