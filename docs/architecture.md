...
Phase 2 capabilities (client portal, booking, payments, CRM sync) extend this same
architecture rather than replacing any part of it — see the relevant research notes
(`docs/research/auth-strategy.md`, `docs/research/phase-2-integrations.md`) and the ADRs in
`docs/adr/` for how each attaches to the components described above.
